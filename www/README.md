# <img src="favicon.ico" width="4%"> ZERO STRIKE
Welcome to ZERO STRIKE!

__ZERO STRIKE__ is a __First-Person-Shooter__ like the orginal ([FPS1](https://github.com/Parking-Master/FPS)). It features a wide variety of customization, in-game experience, and more! Read more to see what the game has.
<br>
<br>
...
<p align="center"><a href="https://zerostrike.example">f p s 2 . p a r k i n g m a s t e r . t k </a></p>

## About
Why is ZERO STRIKE better than the original?
### 1. Performance
...
__ZERO STRIKE 1__ - 100 - 2(5 + 9 + 9) = 54

__ZERO STRIKE__ - 100 - 2(2 + 4 + 3) = 82
...
As you can see in the total negative performance, ZERO STRIKE has almost _no negative performance_ compared to FPS1.
### 2. Style
...
### 3. Features & Misc
In _ZERO STRIKE_, there are a LOT more features compared to ZERO STRIKE 1. All new/old features are below.
...
### Overall
An overall rating for ZERO STRIKE 1 is:<br>
50/100
...
The overall rating for ZERO STRIKE is:<br>
100/100
...
_Note: These are minimized help lists. To view the full ones, go to [zerostrike.example](https://zerostrike.example) and click "help"._
...
##### Vertex
The map "Vertex" appeared several times in the first prototypes of ZERO STRIKE 1.
...
##### Ghost City
The Ghost Map also appeared in ZERO STRIKE 1, but not until the very end of the game developement.
...
Or you can report bugs and send feature requests in the "Issues" section, [here](https://github.com/Parking-Master/ZERO STRIKE/issues/new).
